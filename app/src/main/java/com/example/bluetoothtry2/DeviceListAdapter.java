...
public class DeviceListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            textName = v.findViewById(R.id.nameInSinleDeviceInfo);
            textAddress = v.findViewById(R.id.macInSinleDeviceInfo);
            linearLayout = v.findViewById(R.id.linearLayoutInSingledeviceInfo);
        }
    }
